  ...
  <Card className="p-6 h-full flex flex-col">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-auto">
        <a 
            ...
            className="inline-flex items-center justify-center text-center bg-blue-600 text-white font-bold py-2 px-3 rounded-md hover:bg-blue-700 transition-colors text-sm"
        >
          LinkedIn
        </a>
        <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center text-center bg-green-600 text-white font-bold py-2 px-3 rounded-md hover:bg-green-700 transition-colors text-sm"
        >
          Upwork
        </a>
        <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center text-center bg-gray-800 text-white font-bold py-2 px-3 rounded-md hover:bg-gray-900 transition-colors dark:bg-gray-600 dark:hover:bg-gray-500 text-sm"
        >
          Fiverr
        </a>
    </div>
